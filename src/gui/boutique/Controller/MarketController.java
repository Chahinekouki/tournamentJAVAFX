package gui.boutique.Controller;
...
public class MarketController implements Initializable {
    ...
    private List<Fruit> getData() {
        ...
        fruit.setName("Kiwi");
        fruit.setPrice(2.99);
        fruit.setImgSrc("/gui/boutique/img/kiwi.png");
        ...
        fruit.setPrice(3.99);
        fruit.setImgSrc("/gui/boutique/img/coconut.png");
        ...
        fruit.setName("Peach");
        fruit.setPrice(1.50);
        fruit.setImgSrc("/gui/boutique/img/peach.png");
        ...
        fruit.setPrice(0.99);
        fruit.setImgSrc("/gui/boutique/img/grapes.png");
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            for (int i = 0; i < fruits.size(); i++) {
                ...
                fxmlLoader.setLocation(getClass().getResource("/gui/boutique/views/item.fxml"));
